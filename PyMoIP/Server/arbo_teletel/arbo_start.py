...
PageDir="/home/pi/python/PyMoIP/TestPages/Serveur-Teletel/"
FirstFile=2  # Page 2 = 3614
LastFile=2   # Page 3 = 3615
PrefixFile="teletel"
GuideLink="teletel-mgs"
TimeoutLink=""    #"arbo_demo-jet7"
TimerLink=""      #"arbo_demo-jet7"
ConstList=[]      # Données 'en dur' ajoutées dynamiquement à la page
...
FieldList=[[17,12,[],"Text01",29,"."]]    # Un champ supplémentaire est ajouté dynamiquement si SUITE pour saisie des 'données complémentaires' ,[22,4,[],"Text02",20,"."]]
...
TimeoutLimit=240      # Nombre de secondes depuis SetArbo() avant declanchement 
TimerDelay=60        # Nombre de secondes d'inactivite avant declanchement

Module="module_teletel"
#
