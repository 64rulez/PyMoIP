...
class Command(functools.partial):
    ...
    def __init__(self, *args, **kwargs):
        print("Character.py-> Command(__init__)")
        print(args)
...
class Character(_types.Character, metaclass=CharacterClass):
    ...
    def __init__(self, name=None):
        ...
        print("Character.py->__init__()")
        print("_parser=_command_parser")

    def message(self, msg, showdebug=True):
        if showdebug==True:
          print("character.py->message(len=" + str(len(msg)) + ")")
          for char in msg:
    ...
    def _command_parser(self, line: str):
        print("character.py->_command_parser()")
    ...
    def _dead_parser(self, line: str):
        print("character.py->_dead_parser()")
